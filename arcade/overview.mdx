...
icon: "gamepad"
description: "The participation layer of the network"
---
...
**555 Arcade** is the participation layer of Render Network Protocol — where the economic system becomes visible to participants. It turns play into verifiable economic input, links games into one normalized competitive surface, and keeps communities active even when the creator is offline. All activity is verified via the [Verifiable Attention Protocol (VAP)](/protocol/vap).
