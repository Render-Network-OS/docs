...
title: "sw4p"
icon: "bridge"
description: "The settlement rail for multi-chain participation"
---

<Info>**Status: Live** — sw4p is operational.</Info>

# sw4p

**sw4p** is the settlement rail of Render Network Protocol. It gives the system native cross-chain value movement — USDC across chains without custody, excessive fees, or manual bridging friction. Built on Circle's CCTP V2 (Cross-Chain Transfer Protocol).
