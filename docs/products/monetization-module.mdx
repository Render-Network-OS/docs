...
icon: "coins"
description: "The surfaces where participation becomes revenue"
---

## Where Participation Becomes Revenue

The Monetization Module is where economic activity across the Render Network Protocol converts into revenue. An on-chain marketplace, smart campaign automation, and verifiable analytics connect advertisers to invested communities and automate fair, transparent payouts.
...
<Note>
  Continue with: [Monetization Contract](/products/monetization-contract)
</Note>
