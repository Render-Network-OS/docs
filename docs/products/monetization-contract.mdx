...
- **Hyperlink (Smart Payment Links)**: Multi-chain USDC payment links at [555hyper.link](https://555hyper.link) with universal gas abstraction (pay gas in the asset being moved). Cross-chain settlement through [sw4p](/sw4p), native USDC at both endpoints. Vanity URLs (`/@alice`), QR codes, webhook system, and claimable payouts.
