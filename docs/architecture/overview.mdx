...
Render Network Protocol (RNDRNTWRK) is the economic operating system for human and agent media. It consists of six operational layers that work together to make participation measurable, value-bearing, and programmable across human and agent media: distribution (555stream), participation (555 Arcade), proof (VAP), settlement (sw4p), yield (sw4p Earn), and operations (Alice). $555 coordinates the system.
