---
title: "Glossary"
description: "The common language of the RNDRNTWRK"
icon: "book"
---
...
- **Switchboard VRF:** Verifiable randomness provider used by RNDRNTWRK arcade games and prediction markets
...
- **AGG (Payment Aggregator):** Routes payments across chains via HTTP 402 and the sw4p settlement engine
...
- **sw4p:** Native USDC settlement engine across 7 chains plus a USDT corridor including Tron. Universal gas abstraction; users pay gas in the asset being moved. 15-state lifecycle with checkpointed recovery.
- **@sw4p/kit:** Agent-native MCP server for sw4p, MCP, AP2 Cart Mandates, x402 V2, A2A, ERC-7683 intents in one package
