...
<Note>
  Related: [Fee Distribution (ARP / Buybacks / Treasury)](/tokenomics/fee-distribution) · [Monetization Contract](/products/monetization-contract) · [CTRL Control Panel](/products/ctrl-control-panel)
</Note>
...
- **Monetization Contract** — Encodes splits (creator, ARP (Audience Reward Pool), buybacks, treasury, platform), budgets, and events.
