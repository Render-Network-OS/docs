...
icon: "code"
description: "Build on the economic layer beneath human and agent media"
---

## Build on the Economic Layer

RNDRNTWRK exposes the primitives you need to build participation-native applications: verification, routing, settlement, overlays, stateful event streams, and cross-chain movement. If you want to build systems where interaction is measurable and value-bearing, this is the surface to build on.
