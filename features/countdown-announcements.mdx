...
description: "Time-based participation prompts for scheduling, launches, and synchronized engagement"
icon: "hourglass-half"
---
  ...
  "data": [
    {
      ...
      "fontSize": 16,
      "is_visible": true,
      "target_time": "2026-06-15T20:00:00Z",
...
```json
{
  ...
  "fontSize": 16,
  "isVisible": true,
  "targetTime": "2026-06-16T15:00:00Z",
...
<AccordionGroup>
  <Accordion title="Countdown Not Showing on Overlay">
    **Check**:
  ...
  <Accordion title="Preview Erratic">
