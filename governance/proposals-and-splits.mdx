...
Stakeholders vote to configure the Treasury split between Creator and Stakeholders within a bounded range (e.g., 20/80 ↔ 80/20). Proposals manage policy parameters like minimum buyback %, unbonding windows, and campaign guardrails.
