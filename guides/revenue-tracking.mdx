...
description: "Monitor earnings and manage RNDR tokens"
---

## Real-Time Revenue Dashboard

Track your streaming earnings, RNDR token holdings, and performance metrics with comprehensive analytics and management tools.
...
{" "}
<Card title="RNDR Balance" icon="coins">
  Current token holdings and value
</Card>
