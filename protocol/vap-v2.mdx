...
icon: "flask"
description: "Where the proof layer is going next"
---

# VAP v2: Research Design

<Warning>This is a research document. VAP v2 is validated but **not deployed to production**. The current live system runs VAP v1 (see [VAP documentation](/protocol/vap)).</Warning>

VAP v2 is the next-generation proof layer for the Render Network Protocol. After 14 weeks of research, the design has been validated with **234 tests passing** and **all 5 attack trees marked SECURE**.
