...
**AGG (Aggregator)** is the routing layer for value movement across the Render Network Protocol. It abstracts away the complexity of blockchain payments, allowing users to pay with any token on any chain.
