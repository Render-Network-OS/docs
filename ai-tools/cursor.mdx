...
<Card title="API Reference" icon="code" href="/api-reference">
  Full endpoint reference with authentication and request examples.
</Card>

<Card title="555x402 Suite" icon="bolt" href="/555x402/overview">
  The protocol tools powering verified attention and payments.
</Card>
</CardGroup>
